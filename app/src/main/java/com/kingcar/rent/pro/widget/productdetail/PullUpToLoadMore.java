package com.kingcar.rent.pro.widget.productdetail;
...
public class PullUpToLoadMore extends ViewGroup {
    ...
    PullScrollView topScrollView;
    DetailWebView  bottomScrollView;
    ...
    private void init() {
        ...
        post(new Runnable() {
            @Override
            public void run() {
                topScrollView = (PullScrollView) getChildAt(0);
                bottomScrollView = (DetailWebView) getChildAt(1);
                topScrollView.setScrollListener(new PullScrollView.ScrollListener() {
                    @Override
                ...
                bottomScrollView.setScrollListener(new DetailWebView.ScrollListener() {
                    @Override
                    public void onScrollToBottom() {
