...
import com.kingcar.rent.pro.utils.Location;
import com.kingcar.rent.pro.utils.MapUtil;
import com.kingcar.rent.pro.utils.MyDistanceUtil;
...
public class MapDialog extends Dialog {
    ...
    public MapDialog(Context context,Location loc_now,Location loc_end) {
    	super(context,R.style.Base_AlertDialog);
    ...
    private void initApps() {
    	apps = MapUtil.getMapApps(context);
    	//只显示前5个应用
    ...
    private View.OnClickListener applistener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
			...
			case "com.baidu.BaiduMap":
				MapUtil.startNative_Baidu(context,loc_now, loc_end);
				break;
			case "com.autonavi.minimap":
                MapUtil.startNative_Gaode(context,loc_end);
				break;
			}
            MapDialog.this.dismiss();
        }
